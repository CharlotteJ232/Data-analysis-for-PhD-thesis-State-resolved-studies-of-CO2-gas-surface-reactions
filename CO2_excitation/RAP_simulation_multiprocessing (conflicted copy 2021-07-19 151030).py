    ...
    for fx in fx_list:
        for z0 in z0_list: 
            for cg in cg_list:
                ...
                filename='fx_'+str(fx)+'_z0_'+str(z0)+'_lens_'+str(lens)+'_vel_'+str(vel)+'_fwhmv_'+str(fwhmv)+'_lam_'+str(lam)+'_cg_'+str(cg)+'_ang_'+str(ang)+'_rx_'+str(rx)+'_ry_'+str(ry)+'_nmax_'+str(nmax)+filenameaddition'.txt'
                if save:
                    pop = np.array(pop)
