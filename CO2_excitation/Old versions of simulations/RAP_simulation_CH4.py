...
savefolder = folderstart+'Laser/Simulations/CH4/'
save=True

## Expt input variables
lam=3.30e-6 # wavelength (m)
fx=0.1       # focus length of lens in xz plane (m)
...
cg=np.sqrt(1) # transition probability (Clebsch-Gordan coefficient)

pcut=5e-05 # minimum laser power for integration (W)
pmin=0     # minimum laser power for fluence curve (W)
pmax=0.5     # maximum laser power for fluence curve (W)
pstep=0.01 # laser power step for fluence curve (W)  , was 0.02
