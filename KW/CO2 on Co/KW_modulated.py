...
#old measurement cold cathode pressure gauge of co2 on co2
...
#old measurement QMS of co2 on co2
...
# #background test 
# folder = '2023/12 Dec/231207/Pressure/'
# onresonance = False
# modulation_frequency = 3 #Hz
...
# file = 'KW07'
# measured_laser = True
# file_laser = 'KW06_laser'

# #second day CO2 on Co, different transition and beam
# folder = '2023/12 Dec/231212/Pressure/'
# onresonance = False
# modulation_frequency = 3 #Hz
...
# file = 'kw01'
# measured_laser = True
# file_laser = 'KW01_laser'

# axis=None
# axis=[0, None, 0, 5E-10]
# axis_laser=[0, None, 0, 10000]
...
# stop =75
# max_timeshift = 1
# file = 'test01_pressure'
# measured_laser = True
# file_laser = 'KW01_laser'

#test measurement
folder = '2023/12 Dec/231214/kw/'
onresonance = True
modulation_frequency = 3 #Hz
...
#repeat of CO2 on CO2
folder = '2023/12 Dec/231215/kw/'
onresonance = True
modulation_frequency = 3 #Hz
start = 150 #cannot be 0 for some reason
stop =1800
max_timeshift = 1
file = 'kw03'
measured_laser = True
file_laser = 'KW03_laser'

axis=[2.95, 3.05, 0, 50E-10]
axis_laser=[2.95, 3.05, 0, 50000]


#CO2 on Co with D2
folder = '2024/02 Feb/240222/kw/'
onresonance = True
modulation_frequency = 3 #Hz
start = 160 #cannot be 0 for some reason
stop =6300
max_timeshift = 1
file = 'kw01'
measured_laser = True
...
axis=[2.95, 3.05, 0, 10E-9]
axis_laser=[2.95, 3.05, 0, 100000]



# axis=None
# axis=[0, None, 0, 59E-10]
# axis_laser=[0, None, 0, 100000]
...
def main():
    ...
    plt.axis([x_min, x_max,0,np.max(np.abs(fft[10:]))]) #50: because otherwise the 1/f noise would dominate
    if axis:
        plt.axis(axis)
    plt.grid()
    plt.xlabel('Freq (Hz)')
