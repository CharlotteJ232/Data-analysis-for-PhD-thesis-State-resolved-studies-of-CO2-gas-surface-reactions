...
data_folder = directory+'DATA/2020/10 Oct/201009/TOF/'
avg_mass = (9.5*0.004+1*0.04+0.5*0.044)/20

data_folder = directory+'DATA/2020/10 Oct/201009/TOF2/'
avg_mass = 0.044

data_folder = directory+'DATA/2020/10 Oct/201016/TOF/'
avg_mass = 0.044

data_folder = directory+'DATA/2020/10 Oct/201027/TOF/'
avg_mass = 0.004

# data_folder = directory+'DATA/2020/10 Oct/201027/TOF2/'
# avg_mass = 0.004
# start_dataset = 8
# nr_of_datasets = 6
# data_positions = [46, 35, 25, 15, 5, 0] #positions on moving stage (mm), corresponding to number of dataset above

# data_folder = directory+'DATA/2019/04 Apr/190423/TOF/'
# avg_mass = 0.004
# start_dataset = 1
# nr_of_datasets = 6
# data_positions = [46, 35, 25, 15, 5, 0] #positions on moving stage (mm), corresponding to number of dataset above

data_folder = directory+'DATA/2020/10 Oct/201029/TOF/'
avg_mass = 0.004

data_folder = directory+'DATA/2020/10 Oct/201029/TOF2/'
avg_mass = 0.004

data_folder = directory+'DATA/2020/10 Oct/201029/TOF3/'
avg_mass = 0.004

data_folder = directory+'DATA/2020/11 Nov/201102/TOF/'
avg_mass = 0.004
