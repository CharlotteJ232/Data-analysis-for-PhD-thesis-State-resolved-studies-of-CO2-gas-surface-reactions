...
experiment_list = [] #list contains tuples (data_folder, nozzle_temp, avg_mass)

experiment_list.append((directory+'DATA/2020/01 Jan/200128/TOF/'
, 300, (0.1*0.004+2.5*0.040)/3.5))

experiment_list.append((directory+'DATA/2020/02 Feb/200204/TOF/'
, 300, 0.004))

experiment_list.append((directory+'DATA/2020/02 Feb/200218/TOF/'
, 300, (9*0.004+1*0.040)/10))

experiment_list.append((directory+'DATA/2020/02 Feb/200220/TOF/'
, 300, (3*0.004+2*0.040)/10))

experiment_list.append((directory+'DATA/2020/03 Mar/200306/TOF/'
, 300, (19*0.004+1*0.040)/20))

experiment_list.append((directory+'DATA/2020/03 Mar/200310/TOF/'
, 300, (0.5*0.004+3*0.040)/3.5))

experiment_list.append((directory+'DATA/2020/03 Mar/200311/TOF/'
, 300, (19*0.004+1*0.040)/20))

experiment_list.append((directory+'DATA/2020/05 May/200511/TOF/'
, 300, (8*0.004+2*0.040)/10))

experiment_list.append((directory+'DATA/2020/05 May/200519/TOF/'
, 300, (19*0.004+0.5*0.040)/19.5))

experiment_list.append((directory+'DATA/2020/07 Jul/200724/TOF/'
, 600, 0.004))

experiment_list.append((directory+'DATA/2020/07 Jul/200727/TOF/'
, 600, 0.004))

experiment_list.append((directory+'DATA/2020/08 Aug/200813/TOF/'
, 500, 0.004))

experiment_list.append((directory+'DATA/2020/08 Aug/200813_2/TOF/'
, 400, 0.004))

experiment_list.append((directory+'DATA/2020/08 Aug/200825/TOF/'
, 500, 0.004))

experiment_list.append((directory+'DATA/2020/09 Sep/200904/TOF/'
, 700, 0.004))

experiment_list.append((directory+'DATA/2020/09 Sep/200910/TOF/'
, 750, 0.004))
...
############# Script ########################################################  
    for experiment in experiment_list:
        data_folder, nozzle_temp, avg_mass = experiment
        global savefolder 
        savefolder = data_folder+'Images/'+str(gas_mass * 1000)+'/corrected/'
        print(data_folder)
